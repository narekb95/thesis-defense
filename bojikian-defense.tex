...
\begin{frame}[t]{Introduction}
	\begin{columns}
		...
		\begin{column}[c]{.5\textwidth}
			...
			\only<8>{\makebox[\textwidth][c]{\includegraphics{figures/st-optimal.eps}}}
			\only<9>{\makebox[\textwidth][c]{\includegraphics{figures/graph.eps}}}
			\only<10>{\makebox[\textwidth][c]{\includegraphics{figures/matching.eps}}}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{itemize}
	...
	\uncover<6->{\item If maximum matching can be solved efficiently in $G$, it can be solved efficiently in $f(G)$.}
	\end{itemize}
\end{frame}
