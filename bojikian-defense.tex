...
\begin{frame}[t]{Methods and results - Preserving properties}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item[--] Neighborhood diversity number - does not change.
			\item[--] Chordal graphs - closed under the reduction.
			\item[--] Interval- Circular-arc- and co-Comparability- graphs - also closed.
		\end{itemize}
	\end{itemize}
\end{frame}
...
\end{frame}
\begin{frame}{Methods and results - Different problem same solution}
	Do we even have this?
\end{frame}
\begin{frame}{Methods and results - Specific algorithm}
	Or this?
\end{frame}
\end{document}
